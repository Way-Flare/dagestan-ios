...
#Preview {
    let place = Place(
        ...
        images: [URL](repeating: URL(string: "https://i.pinimg.com/564x/83/26/63/832663e46708366b861d8242ba5bc4cd.jpg")!, count: 8),
        rating: 5.0,
        workTime: "Открыто • до 21:00",
        tags: nil,
        feedbackCount: nil
    )
    return PlaceView(place: place, isVisible: .constant(true))
}
